  ...
  return (
    <div class="footer">
      <div class="footer-container">
        <p>Well, let's stay connected?</p>

        <div class="footer-icon-container">
          <div id="github">
            <a href="https://github.com/pvshkng/">
              <svg
          ...
          <div id="gitlab">
            <a href="https://gitlab.com/p.kungsapattarakul">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24"
                width="21"
          ...
          <div id="linkedin">
            <a href="https://www.linkedin.com/in/puvish">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24"
                width="21"
          ...
          <div id="youtube">
            <a href="https://www.youtube.com/channel/UCBywDzrSxHcoMT7igF2IScg">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24"
                width="21"
          ...
          <div id="email">
            <a href="mailto:pvsh_kng@outlook.com">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24"
                width="21"
